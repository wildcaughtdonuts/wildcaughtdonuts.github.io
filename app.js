...
submitBtn.addEventListener("click", async () => {
  ...
  const apiUrl = `${BASE_URL}/getBrTitleInfo?serviceKey=${API_KEY}&sigunguCd=${sigunguCd}&bjdongCd=${bjdongCd}&bun=${bun}&ji=${ji}&numOfRows=150`;
...
submitBtn2.addEventListener("click", async () => {
  ...
  const apiUrl = `${BASE_URL}/getBrRecapTitleInfo?serviceKey=${API_KEY}&sigunguCd=${sigunguCd}&bjdongCd=${bjdongCd}&bun=${bun}&ji=${ji}&numOfRows=150`;
...
submitBtn3.addEventListener("click", async () => {
  ...
  const apiUrl = `${BASE_URL}/getBrFlrOulnInfo?serviceKey=${API_KEY}&sigunguCd=${sigunguCd}&bjdongCd=${bjdongCd}&bun=${bun}&ji=${ji}&numOfRows=150`;
